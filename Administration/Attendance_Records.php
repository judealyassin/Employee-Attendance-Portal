...
<a href="<?php echo $URL; ?>?lang=ar" class="btn btn-primary square-btn-adjust"><img src="../languages/images/ar.png" /></a>
        ...
        <div id="page-wrapper" >
		 ...
		 <div class="panel panel-default">
                      ...
                      <?php echo $lang['Attendance_Records']; ?>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $lang['Check_In_Date_Time']; ?></th>
                                           
                                            <th><?php echo $lang['Check_Out_Date_Time']; ?></th>
                                    ...
                                    <tbody>
									   ...
									   <?php
					$sql1 = mysqli_query($dbConn,"select * from attendance_records where Employee_ID='$E_ID' order by ID ASC");
					while ($row1 = mysqli_fetch_array($sql1)){
						
						$ID = $row1['ID'];
						$Date = $row1['Date'];
						$Check_In_Date_Time = $row1['Check_In_Date_Time'];
						$Check_Out_Date_Time = $row1['Check_Out_Date_Time'];
                    ...
                    <tr class="grade">
                        <td><?php echo $ID; ?></td>
                        <td><?php echo $Date; ?></td>
                        <td><?php echo $Check_In_Date_Time; ?></td>
                        <td><?php echo $Check_Out_Date_Time; ?></td>
