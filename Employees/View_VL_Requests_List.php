...
$sql = mysqli_query($dbConn,"select * from employees where ID='$E_ID'");
...
<a href="<?php echo $URL; ?>?lang=ar" class="btn btn-primary square-btn-adjust"><img src="../languages/images/ar.png" /></a>
        ...
        <div id="page-wrapper" >
		 ...
		 <div class="panel panel-default">
                        ...
                        <?php echo $lang['Vacations_Leaves_Requests']; ?> | <a href="Add_New_Request.php" class="btn btn-primary">
						 ...
						 <?php echo $lang['Add_New_Leave_Request']; ?>
						</a>
						...
						| 
						 ...
						 <a href="Add_New_Request_2.php" class="btn btn-primary">
						 ...
						 <?php echo $lang['Add_New_Vacation_Request']; ?>
						</a>
						...
						<a style="visibility:<?php echo $visibility; ?>" href="My_Employees_Vacations_Leaves_Requests.php" class="btn btn-primary">
						
						<?php echo $lang['My_Employees_Vacations_Leaves_Requests']; ?></a>
						...
						<div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								   ...
								   <?php
					$sql1 = mysqli_query($dbConn,"select * from vacations_leaves where Employee_ID='$E_ID' order by ID ASC");
