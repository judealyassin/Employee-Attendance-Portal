...
<a href="<?php echo $URL; ?>?lang=ar" class="btn btn-primary square-btn-adjust"><img src="../languages/images/ar.png" /></a>
        ...
        <div id="page-wrapper" >
		 ...
		 <div class="panel panel-default">
						...
						<?php echo $lang['My_Employees_Vacations_Leaves_Requests']; ?>
				...
				$sql123 = mysqli_query($dbConn,"select * from managers_employees where Manager_ID='$E_ID' order by ID ASC");
				while ($row123 = mysqli_fetch_array($sql123)){
				$Employee_ID = $row123['Employee_ID'];
		   
									   
									   
					$sql1 = mysqli_query($dbConn,"select * from vacations_leaves where Employee_ID='$Employee_ID' order by ID ASC");
 ...
 <a href="View_Request_Documents_2.php?VL_ID=<?php echo $VL_ID; ?>" class="btn btn-primary" role="button"><?php echo $lang['View_Documents']; ?></a>
...
{window.location='Accept_Request.php?Manager_Status=<?php echo $Manager_Status; ?>&Total_Days=<?php echo $Total_Days; ?>&Employee_ID=<?php echo $Employee_ID; ?>&VL_ID=<?php echo $VL_ID; ?>';}" class="btn btn-success" role="button"><?php echo $lang['Accept']; ?></a>
