...
<a href="<?php echo $URL; ?>?lang=ar" class="btn btn-primary square-btn-adjust"><img src="../languages/images/ar.png" /></a>
        ...
        <div id="page-wrapper" >
		 ...
		 <div class="panel panel-default">
                       ...
                       <?php echo $lang['Vacations_Leaves_Requests_Documents']; ?> | <a href="Add_New_Document.php?VL_ID=<?php echo $VL_ID; ?>" class="btn btn-primary"><?php echo $lang['Add_New_Document']; ?></a>
