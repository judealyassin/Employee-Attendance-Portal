...
<a href="<?php echo $URL; ?>?lang=ar" class="btn btn-primary square-btn-adjust"><img src="languages/images/ar.png" /></a>
        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
				...
				<div class="slider-wrapper theme-default" style="margin-top:-15px !important">
            ...
            <div id="slider" class="nivoSlider">
			 ...
			 <center>
			<h4 style="text-align:center" style="margin-top:-50px !important">  <?php echo $lang['Footer']; ?></h4>
		     </center>
			 </div>
